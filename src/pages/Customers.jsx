...
const tableData = [
  ...
  },
  {
    title: "Project Name",
    render: (rowData) => {
      return <span>{rowData.ProjectName}</span>;
    },
  },
  {
    title: "Location",
  ...
  },
  {
    title: "Budget",
    render: (rowData) => {
      return <span>{rowData.Budget}</span>;
    },
  },
  {
    title: "Weeks",
    render: (rowData) => {
      return <span>{rowData.Weeks}</span>;
    },
  },
];
function Customers() {
  return <Table data={customersData} columns={tableData} />;
}
